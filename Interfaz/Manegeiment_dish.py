...
windows_manege_dish.configure(bg = "#FFFFFF")
#---------------------------------------------------------------
...
manegementtitle = Label(windows_manege_dish, text = "Italian Restaurant", font = ("Arial", 40 , "bold"), bg = "#AAAAAA", fg = "#B31200", relief = "raised")
manegementtitle.place(x = 70 , y = 20) 
#---------------------------------------------------------------
# label and entry name dish (Configuracion y ubicacion)
name_dish = Label(windows_manege_dish, text = "Name dish", font = ("Arial", 12), bg = "#FFFFFF")
name_dish.place(x = 70 , y = 200)
# Entry name 
entry_dish_name = Entry(windows_manege_dish)
entry_dish_name.place(x = 70 , y = 230)
#---------------------------------------------------------------
# label and entry price dish (Configuracion y ubicacion)
price_dish = Label(windows_manege_dish, text = "Price dish", font = ("Arial", 12), bg = "#FFFFFF")
price_dish.place(x = 70 , y = 260)
#Price entry 

entry_price_dish = Entry(windows_manege_dish)
entry_price_dish.place(x = 70 , y = 290)
#---------------------------------------------------------------
# label and entry description dish (Configuracion y ubicacion)
ldescrpit_dish = Label(windows_manege_dish, text = "Description dish", font = ("Arial", 12), bg = "#FFFFFF")
ldescrpit_dish.place(x = 70 , y = 320)
#Description entry 
entry_dish_description = Entry(windows_manege_dish)
entry_dish_description.place(x = 70 , y = 350)
#---------------------------------------------------------------
# label and entry availability dish (Configuracion y ubicacion)
availability_dish = Label(windows_manege_dish, text = "Availability dish", font = ("Arial", 12), bg = "#FFFFFF")
...
entry_stock_dish.place(x = 70 , y = 410)
#---------------------------------------------------------------
# button add dish (Configuracion y ubicacion)
add_dish = Button(windows_manege_dish, text = "Add dish", font = ("arial", 12), bg = "#AAAAAA", fg = "#FFFFFF", command = add_dish_to_table)
